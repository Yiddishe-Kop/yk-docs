<template>
  <div class="flex flex-col min-h-screen bg-gray-300">
    <nav class="sticky top-0 z-20 bg-gray-800">
    ...
    <div class="fixed top-0 left-0 right-0 z-0 pt-16 pb-32 bg-gray-800">
      <header class="px-4 py-10 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <portal-target name="page-title" class="text-3xl font-bold leading-9 text-white"></portal-target>
      </header>
    </div>

    <main class="relative z-10 flex-1 mt-24">
      <div class="px-4 pb-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <nuxt class="px-5 py-6 bg-white rounded-lg shadow sm:px-6" />
      </div>
    </main>
